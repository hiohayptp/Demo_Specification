...
public class TestAddress {
    public static void main(String[] args) {
        ...
        String a = "114 Thăng Long, Phường 4, Tân Bình, Thành phố Hồ Chí Minh, Việt Nam";
    ...
    private static String formatAddress(String address, LocationTypeEnum locationTypeEnum) {
        ...
        address = Normalizer.normalize(address, Normalizer.Form.NFD).replaceAll("\\p{InCombiningDiacriticalMarks}+", "");
